...
function startTimer() {
    ...
    countDownDate = new Date(countDownDate.getTime() + 62000);
    var x = setInterval(function () {
        ...
        if (distance < 0) {
            ...
            TimeendElement.innerHTML = 'Moving to the 2nd trial...'
...
function postdata() {
    ...
    fullform.setAttribute('action', "competition2")
    ...
    wpm7input.setAttribute('name', "first_Trial_WPM");
    cpm7input.setAttribute('name', "first_Trial_CPM");
