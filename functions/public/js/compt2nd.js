...
function startTimer() {
    ...
    var x = setInterval(function () {
        ...
        if (distance < 0) {
            ...
            TimeendElement.innerHTML = 'Moving to the 3rd trial...'
...
function postdata() {
    ...
    fullform.setAttribute('action', "competition3")
    ...
    wpm7input.setAttribute('name', "second_Trial_WPM");
    cpm7input.setAttribute('name', "second_Trial_CPM");
