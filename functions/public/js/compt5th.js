...
function startTimer() {
    ...
    var x = setInterval(function () {
        ...
        if (distance < 0) {
            ...
            TimeendElement.innerHTML = 'Moving to the 6th trial...'
...
function postdata() {
    ...
    fullform.setAttribute('action', "competition6")
    ...
    wpm7input.setAttribute('name', "fifth_Trial_WPM");
    cpm7input.setAttribute('name', "fifth_Trial_CPM");
