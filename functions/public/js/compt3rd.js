...
function startTimer() {
    ...
    var x = setInterval(function () {
        ...
        if (distance < 0) {
            ...
            TimeendElement.innerHTML = 'Moving to the 4th trial...'
...
function postdata() {
    ...
    fullform.setAttribute('action', "competition4")
    ...
    wpm7input.setAttribute('name', "third_Trial_WPM");
    cpm7input.setAttribute('name', "third_Trial_CPM");
