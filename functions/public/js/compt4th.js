...
function startTimer() {
    ...
    var x = setInterval(function () {
        ...
        if (distance < 0) {
            ...
            TimeendElement.innerHTML = 'Moving to the 5th trial...'
...
function postdata() {
    ...
    fullform.setAttribute('action', "competition5")
    ...
    wpm7input.setAttribute('name', "fourth_Trial_WPM");
    cpm7input.setAttribute('name', "fourth_Trial_CPM");
